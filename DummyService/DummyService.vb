...
Public Class DummyService
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        gobjEvent.WriteToEventLog("Service Start Banner:    *       DummyService STARTING            *")
        gobjEvent.WriteToEventLog("Service Start Banner:    ******************************************")
...
Public Class Worker
    ...
    Public Sub StopWork()
        ...
        gobjEvent.WriteToEventLog("Service Stopping Banner: *       DummyService STOPPED             *")
        gobjEvent.WriteToEventLog("Service Stopping Banner: ************************************************")
    ...
    Function StartProcess() As Boolean
        ...
        Try
            ...
            gobjEvent.WriteToEventLog("StartProcess : Doing dummy stuff")

            For i = 0 To 1000

                gobjEvent.WriteToEventLog("StartProcess : Writing to log for a bit of practice")

                i = i + 1

            Next

            gobjEvent.WriteToEventLog("StartProcess : Finished doing stuff")
